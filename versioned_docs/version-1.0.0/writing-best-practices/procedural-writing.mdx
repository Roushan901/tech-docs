...
```
## What's next
- [Set up backup authentication methods](./writing-best-practices-commands-code-ui)
- [Review your security settings](./writing-best-practices-review-checklist)
- [Manage connected devices](./writing-best-practices-content-structure)
```
