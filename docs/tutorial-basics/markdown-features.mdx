...
TechDocs includes several interactive components to make your documentation more engaging:
...
<InteractiveCodeEditor 
  ...
  initialCode={`// Try editing this code
...
Explore all interactive components in our [Interactive Components Demo](/docs/interactive-components) page!
