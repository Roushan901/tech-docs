...
**Poor**: Click [here](./writing-best-practices-content-types) to learn more about authentication
**Better**: [Learn how authentication works](./writing-best-practices-content-types) in our security guide
...
```
## Related topics
- [Prerequisite concept you should know first](./writing-best-practices-audience-and-intent)
- [Next task after completing this one](./writing-best-practices-procedural-writing)
- [Advanced variations of this technique](./writing-best-practices-review-checklist)
```
